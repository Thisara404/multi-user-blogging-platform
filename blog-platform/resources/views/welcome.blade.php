                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-8">
                        <a href="{{ route('blog.index') }}"
                            class="nav-link text-white/90 hover:text-white px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:bg-white/10 hover:backdrop-blur-sm">All
                            Posts</a>
                        @auth
                ...
                <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    ...
                    <div
                        ...
                        <a href="{{ route('blog.index') }}"
                            ...
                            <svg class="mr-3 w-5 h-5 text-blue-300 group-hover:text-pink-300" fill="none"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex space-x-5">
                        ...
                        <!-- GitHub -->
                        <a href="https://github.com/Thisara404"
                            class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:bg-gray-700 transition-all duration-300">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                        ...
                        <!-- LinkedIn -->
                        <a href="https://www.linkedin.com/in/thisara-dasun-1a2464281/"
                            class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:bg-gray-700 transition-all duration-300">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="#"
                                class="text-gray-400 hover:text-white transition-colors duration-300">API
                                Documentation</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-white transition-colors duration-300">System Status</a>
                        </li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-white transition-colors duration-300">Changelog</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="#"
                                class="text-gray-400 hover:text-white transition-colors duration-300">Community
                                Forum</a></li>
                        <li><a href="#"
